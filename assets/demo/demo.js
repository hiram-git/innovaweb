demo = {
  ...
  initFullCalendar: function() {
    ...
    var d = today.getDate();*/
    var dat_cal=mydata_calender();
    
    //var dat_cal = JSON.parse(dat_cal);
    //var dat_cal = JSON.stringify(dat_cal);
    //alert(dat_cal);
    
    var calendar = new FullCalendar.Calendar(calendarEl, {
/*
      titleFormat: function(today) {
...
/*
      ...
      selectable: true,
      events:  dat_cal, //'datacalender.json',
      /*[
        {
          title: 'All Day Event',
          start: new Date('2021-06-28 00:00:00'),
        ...
        /*{
          title: 'Lunch',
          start: new Date('2021-06-28 00:00:00'),
          //end: new Date('2021-06-28 00:00:00'),
  ...
  initDashboardPageCharts: function() {
    ...
    var data_return=mydata();
    var porciones = data_return.split(',');
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: gradientFill,
          borderWidth: 2,
          data: [porciones[0],porciones[1],porciones[2],porciones[3],porciones[4],porciones[5],porciones[6],porciones[7],porciones[8],porciones[9],porciones[10],porciones[11]]
          //data: [0,0,0,90,1300,7890,14150,160,120,140,190,95]
        }]
      },
      options: {
        layout: {
