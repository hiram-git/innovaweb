          ...
          <form>
            <div class="modal-body">  
              ...
              <div class="container mt-2">
                ...
                <div class="row ">
                  <div class="col-md-12">
                  SubTotal: <span id="subtotal" class="lead">: 0</span>
                  </div>
                </div>
                <div class="row ">
                  <div class="col-md-12">
                  Desc. Global: <span id="descuento_global" class="lead">: 0</span>
                  </div>
                </div>
                <div class="row ">
                  <div class="col-md-12">
                  Total_Neto: <span id="total_neto" class="lead">: 0</span>
                  </div>
                </div>
                <div class="row ">
                  <div class="col-md-12">
                  <?=  $idimpuesto ?>: <span id="itbms" class="lead">: 0</span>
                  </div>
                </div>
                <div class="row ">
                  <div class="col-md-12">
                    Saldo: <span id="saldo" class="lead">0</span>
                  </div>
                </div>
                <div class="row ">
                  <div class="col-md-12">
                    Cambio: <span id="cambio" class="lead">0</span>
                  </div>
                </div>
                <div class="row mb-1">
                  <div class="col-md-12">
                   Total: <span id="total" class="lead">Total: 0</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(this.responseText==1){
                    ...
                    if(dormir=='presupuesto'){
                      ...
                      window.location='tarea_factura.php';
                      /*estamos en la misma pantalla de pedido*/
                      location.reload();
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    if(myArr[0].trim()=='1'){
                        ...
                        content: {
                          ...
                          innerHTML: `
                            <div class="row mt-2">
                              ...
                              <label class="col-md-2 text-right" for="input1">Pagado:</label>
                              <div class="col-md-3">
                                <input type="text" id="input1" placeholder="Input 1" class="form-control" value='${parseFloat(pagado).toFixed(2)}' readonly>
                              </div>
                            </div>
                            <div class="row mt-2">
                              <div class="col-md-3">&nbsp;
                              </div>
                              <label class="col-md-2 text-right" for="input2">Cambio:</label>
                              <div class="col-md-3">
                                <input type="text" id="input2" placeholder="Input 2" class="form-control" value='${cambio}' readonly>
                              </div>
                            </div>
                            <div class="row mt-2">
                              <div class="col-md-3">&nbsp;
                              </div>
                              <label class="col-md-2 text-right" for="input3">Total:</label>
                              <div class="col-md-3">
                                <input type="text" id="input3" placeholder="Input 3" class="form-control" value='${total_factura}' readonly>
                              </div>
                            </div>
                          `,
                          },
                     ...
                     // setTimeout(function(){ window.location='doc_pdf_demo.php?idcontrol='+cal_contro_uni+'&idfac='+nro_correlativo+'&tiptran='+tip_tran; }, 2000);
                      ...
                      swal("Error!", "Hubo un error al procesar la factura", "danger", {
                        buttons: false,
                        icon: 'error',
                      });
                      document.getElementById("detalle_desc_global").innerHTML="<br />"+myArr[1];
