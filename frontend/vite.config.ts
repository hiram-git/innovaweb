...
export default defineConfig({
        ...
        runtimeCaching: [
          {
            ...
            urlPattern: /^https?:\/\/innovaweb-api\.test\/api\/v1\/(clientes|inventario|presupuestos)/,
          ...
          },
          {
            ...
            urlPattern: /^https?:\/\/innovaweb-api\.test\/api\/v1\/facturas/,
  ...
  server: {
    ...
    proxy: {
      '/api': {
        target: 'http://innovaweb-api.test',
        changeOrigin: true,
        secure: false,
      },
    },
